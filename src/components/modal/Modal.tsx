...
function Modal({title, message, confirmText, onConfirm, onCancel }: ModalProps) {
  return (
    <div
      tabIndex={-1}
    ...
    >
      <div className="relative w-full max-w-md">
        <div className="relative bg-white items-center justify-center rounded-lg h-full red-glow">
